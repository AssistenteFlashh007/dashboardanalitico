        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-text-secondary border-b border-dark-border">
              ...
              <th className="text-right py-3 pr-4 font-medium">Conversões</th>
            ...
            {campaignPerformance.map((camp) => {
              ...
              return (
                <tr key={camp.nome} className="border-b border-dark-border/50 hover:bg-dark-border/20 transition-colors">
                  <td className="py-3 pr-4 font-medium text-text-primary">{camp.nome}</td>
                  <td className="py-3 pr-4 text-text-secondary">{camp.plataforma}</td>
                  <td className="py-3 pr-4 text-right text-text-secondary">
                    R$ {camp.investido.toLocaleString('pt-BR')}
                  </td>
                  <td className="py-3 pr-4 text-right text-success font-medium">
                    R$ {camp.receita.toLocaleString('pt-BR')}
                  </td>
                  ...
                  <td className="py-3 text-center">
                    <span className={`px-2.5 py-1 rounded-full text-xs font-medium ${statusStyles[camp.status]}`}>
